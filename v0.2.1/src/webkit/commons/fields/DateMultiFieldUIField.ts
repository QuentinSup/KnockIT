module kit.fields.datemultifield {
...
module kit.fields {
    ...
    export class DateMultiFieldUIField extends DateUIField {
        ...
        public oTextUIFieldDay: datemultifield.DateTextUIField
        public oTextUIFieldMonth: datemultifield.DateTextUIField
        public oTextUIFieldYear: datemultifield.DateTextUIField
        ...
        constructor(id: string, value: any, required?: boolean, readOnly?: boolean) {
            ...
            this.oTextUIFieldYear  = new datemultifield.DateTextUIField(id, datemultifield.DateTextFieldTypes.year);
            this.oTextUIFieldMonth = new datemultifield.DateTextUIField(id, datemultifield.DateTextFieldTypes.month, this.oTextUIFieldYear);
            this.oTextUIFieldDay   = new datemultifield.DateTextUIField(id, datemultifield.DateTextFieldTypes.day, this.oTextUIFieldMonth);
            
            this._koComputeIsLastInputValid = ko.pureComputed((): boolean => {
                var sYear_: string = this.oTextUIFieldYear.dataValue();
                var bIsValidYear_: boolean  = this.oTextUIFieldYear.isValidateValue(sYear_) && this.oTextUIFieldYear.isValidateConstraintsValue(sYear_);
                var sMonth_: string = this.oTextUIFieldMonth.dataValue();
                var bIsValidMonth_: boolean = this.oTextUIFieldMonth.isValidateValue(sMonth_) && this.oTextUIFieldMonth.isValidateConstraintsValue(sMonth_);
                var sDay_: string = this.oTextUIFieldDay.dataValue();
                var bIsValidDay_: boolean = this.oTextUIFieldDay.isValidateValue(sDay_) && this.oTextUIFieldDay.isValidateConstraintsValue(sDay_);
