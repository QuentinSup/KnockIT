module kit.ui {
	...
	export class MessageBox extends MVVMDialog {
	    ...
	    // The box template
		private static _stringTemplate: string = '<div data-bind="attr:{id: id}" class="se-ui-messagebox-content"><span class="se-ico-status x-large" data-bind="visible: icon, attr: { \'data-icon\': icon}">&nbsp;</span><pre class="se-ui-text" data-bind="text: text"></pre></div>'
	    // The popin template
		private static _popinTemplate: string = '<div class="se-ui-popin" data-type=""><span class="se-ico-status small" data-icon=""></span><span class="text"></span></div>'
	    ...
	    constructor(title: string, text: string, buttons?: any, callback?: any, opts?: IMessageBoxOptions) {
            ...
            super(title, MessageBox._stringTemplate, buttons, callback, opts);
            this.text = text;
            this.init(opts);
	    }
