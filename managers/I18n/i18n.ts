...
module fr.fwk.knockit.manager {
	...
	var LOCALE_PATH: string = "${path}/i18n/${device}/${app}/${page}/${lang}"
	...
	export class I18n extends BaseManager {
       ...
       public getLanguageFromBrowser(): string {
            var language = helpers.browser.getBrowserInfos().countryCode
            if(language) {
        ...
        public static getStringsUrl(language: string): string {
            return utils.formatString(LOCALE_PATH, {
