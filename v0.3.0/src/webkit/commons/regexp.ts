module fr.ca.cat.regexp {
    ...
    export var AlphaNumerique: RegExp = /^[a-z0-9 ÀÂÉÈÊËÏÎÔÖÛÙÜÇ\-_']*$/i
    export var Alpha: RegExp = /^[a-z ÀÂÉÈÊËÏÎÔÖÛÙÜÇ\-_']*$/i
    ...
    export var NumTelReduit : RegExp=/^(0)([0-9]{9})$/ //10 caractères numériques ( commençant par 0 )
    export var NumDossier: RegExp = /^[0-9]{5}_[A-Z0-9]{10,}$/ // Numéro de dossier valide et extensible à droite du '_'
}