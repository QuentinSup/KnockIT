import { GroupUIField } from '@webkit/core/GroupUIField.class';
import { InputUIField } from '@webkit/form/InputUIField';
    
export class ScreenSequence extends GroupUIField {
    ...
    constructor(id: string, templateName: string, fields: InputUIField[], data: any = {}, animationIn: any = ScreenSequence.defaultAnimationIn, animationOut: any = ScreenSequence.defaultAnimationOut, animationError: any = ScreenSequence.defaultAnimationError) {
