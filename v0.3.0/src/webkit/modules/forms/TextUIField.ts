...
export class TextUIField extends InputUIField {
    ...
    public unformatFunction = null;
    public defaultAutoValidationDelay: number = 2000;

    private _autoValidationDelay: number;
    ...
    public autoValidationDelay: any = "auto";
    ...
    public onFocusEventHandler(e: Event): boolean {
        ...
        let autoValidationDelay: number = isNaN(this.autoValidationDelay)?this.defaultAutoValidationDelay:this.autoValidationDelay;
