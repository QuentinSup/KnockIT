...
let logger: Logger = Logger.getLogger('GlassPanel');
...
export class GlassPanel extends MVVM {
    ...
    private _update(): void {
        let currentStep: number = Number(this.currentStep())
        let totalSteps: number = Number(this.totalSteps())
    ...
    public animate(animation: any, fn?: Function): void {
        let animation_: any = typeof (animation) == 'string' ? { animation: animation } : animation;
