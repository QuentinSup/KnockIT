...
export let getBrowserLanguage = function(): string {
...
export class BrowserInfo {
    ...
    public isProbablyModernUI(): boolean {
        ...
        let isIE: boolean = (navigator.userAgent.indexOf('MSIE') !== -1 || navigator.appVersion.indexOf('Trident/') > 0) ;
