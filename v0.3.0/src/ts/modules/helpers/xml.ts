...
export class XmlConverter {
	 ...
	 */
	public static toJson(xml: Element): any {
		let attributes: any,
			childNodes: any,
			json: any;
		...
		if (xml.hasChildNodes()) {
			...
			$.each(xml.childNodes, function (index: number, childNode: Element) {
				let nodeName: string = childNode.nodeName;
