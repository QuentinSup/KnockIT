...
let _hInstances = {}
let _hInstanceCounter: number = 0
let _currentStackRequests: { [key: string]: IQueryRequest } = {}
let _requestCount: number = 0
...
export class Query {
    ...
    */
    ...
    static create(id?: any, opts?: IQueryOptions): Query {
     ...
     * @returns {object} jQuery handler
     */
    static queryFormData(form: HTMLFormElement, callbacks: any = {}, context?, opts: IQueryOptions = {}): JQueryXHR {
        opts = opts || {};
    ...
    static query(method: string, url: string, data: any, callbacks: any = {}, context?, opts: IQueryOptions = {}): JQueryXHR {
        ...
        if (!opts.silent) {
            ...
            let nb: number = Query.nbQueries() + 1
            Query.nbQueries(nb)
            if(Query.log().isTraceEnabled()) {
        ...
        let currentRequest: IQueryRequest = {
            ID: _requestCount,
            method: method,
            url: url,
            data: data,
        ...
        let jqXHR: JQueryXHR = $.ajax(params)

        jqXHR.always(function (data: any, textStatus: string, jqXHR) {
     ...
     * @memberOf oneesp.module.commons.helper.query#
     */
    static PATCH(url: string, data, callbacks, context?, opts?: IQueryOptions): JQueryXHR {
