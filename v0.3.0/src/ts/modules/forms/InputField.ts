...
import { IValidationRule, RegExpValidationRule } from './index';
...
export function getUID(name: string, ind: number = null): string {
    let id = getId(name, ind);
    let num: number = 0;
    let uid = id;
...
export interface IField {
    ...
    messages: KnockoutObservableArray<InputFieldMessage>
...
export class BaseField extends EventsBinder implements IDisposable  {
    ...
    */
    ...
    public validationConstraints: KnockoutObservableArray<InputFieldValidationConstraint>
    public unvalidatedConstraints: KnockoutObservableArray<InputFieldValidationConstraint> = ko.observableArray<InputFieldValidationConstraint>()
    ...
    public messages: KnockoutObservableArray<InputFieldMessage> = ko.observableArray<InputFieldMessage>([])
    public showMessages: KnockoutObservable<boolean> = ko.observable<boolean>(BaseField.defaultShowMessages)
    ...
    public constructor(id: string, bShowLabel: boolean = true) {
        ...
        this.validationConstraints = ko.observableArray<InputFieldValidationConstraint>()
    ...
    */
    public addWarnConstraint(name: string, fn: KnockoutComputedDefine<boolean>, messageFn?: Function): InputFieldValidationConstraint {
    ...
    */
    public addConstraint(name: string, fn: KnockoutComputedDefine<boolean>, messageFn?: Function, isWarn: boolean = false): InputFieldValidationConstraint {
        var o: InputFieldValidationConstraint = new InputFieldValidationConstraint(name, fn, messageFn, isWarn)
    ...
    public validateConstraints(checkAlls: boolean = true): boolean {
        ...
        var constraintsList: InputFieldValidationConstraint[] = this.validationConstraints()
 ...
 */
export class InputFieldValidationConstraint implements IDisposable {

    public name: string
    public fn: KnockoutComputedDefine<boolean>
    public isWarn: boolean
    public messageFn: Function
    public isValid: KnockoutComputed<boolean>
    
    public constructor(name: string, fn: KnockoutComputedDefine<boolean>, messageFn?: Function, isWarn: boolean = false) {
        this.name = name
        this.fn = fn
        this.isWarn = isWarn
 ...
 * Constraint class for input validation rules
 */
export class InputFieldMessage {
 ...
 * @constructor
 */
export class InputField extends BaseField implements IField, IDisposable {
    ...
    */
    ...
    public template: string = InputField.defaultTemplate;
    public labelTemplate: string = InputField.defaultLabelTemplate;
    public inputTemplate: string = InputField.defaultInputTemplate;
    ...
    */
    public validateValue(): void {
        ...
        var unvalidatedConstraints: InputFieldValidationConstraint[] = []
